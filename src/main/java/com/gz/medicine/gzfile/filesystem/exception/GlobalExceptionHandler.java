//package com.gz.medicine.gzfile.filesystem.exception;
//
...
////            sendEmail("1429264916@qq.com", "贯众心理健康异常日志",jsonData);
////        }catch (Exception e){
////            LOGGER.error("发送邮件异常："+e.getMessage());
////    }
//        return  SimpleResult.error(SimpleCode.ERROR.getCode(), ex.getMessage());
//    }
//
//
//
